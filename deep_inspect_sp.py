...
def deep_inspect():
    ...
    if 'value' in resp and len(resp['value']) > 0:
        ...
        print("--- INSPECCIÓN COMPLETA OP 1201 ---")
        for k, v in fields.items():
            # Imprimir cualquier campo que sea booleano o parezca de combo
            if isinstance(v, bool) or 'combo' in k.lower() or 'venta' in k.lower() or v == 'Yes' or v == 1:
                print(f"{k}: {v}")
    else:
